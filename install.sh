...
do_install() {
  ...
  sudo curl -fsSL "https://github.com/prometheus/node_exporter/releases/download/v$VERSION/node_exporter-$VERSION.linux-amd64.tar.gz" | tar -xzO "node_exporter-$VERSION.linux-amd64/node_exporter" > /home/prometheus/node_exporter
